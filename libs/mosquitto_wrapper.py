...
#   Copyright (C) 2013 by Xose Pérez, Dustin Brewer
#
...
__copyright__ = "Copyright (C) 2013 Xose Pérez, Dustin Brewer"
__license__ = 'GPL v3'
...
class MosquittoWrapper(Mosquitto):
    ...
    def publish(self, topic, value, qos=None, retain=None):
        ...
        Mosquitto.publish(self, topic, value, qos, retain)
    ...
    def ConfigureNewWrapper(config):
        ...
        mqtt.retain = config.get('mqtt', 'retain', False)
